...
//        $this->expectDisabled($c, array('uaid' => 0, 'userID' => null));
//    }
//
...
//        $config = new Config('foo', array('enabled' => 'off'), new Testing_Feature_MockWorld(array()));
...
//        $config = new Config('foo', $stanza, new Testing_Feature_MockWorld($world));
//        $this->assertTrue($config->isEnabled());
